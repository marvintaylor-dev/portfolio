                ...
                <div className="introduction-container" id="home">
                    <section className="introduction-message">
                        <header className="introduction-heading">
                            ...
                            <div className="introduction-message__job-title">Scrum Master</div>
                        </header>
                        <p className="introduction-message__welcome">
                            Hello! Welcome to my portfolio of personal web development projects. I aim to achieve positive outcomes for projects that matter.
                        </p>
